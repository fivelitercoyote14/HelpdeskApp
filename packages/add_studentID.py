...
def add_studentID(self):
        ...
        self.text_editor.insert(tk.END, "studentID: ") #nserts the string "asset tag: " at the end (tk.END) of the text editor.
        ...
        self.text_editor.focus_set() #Moves the keyboard focus to the text_editor widget.
                 #This allows the user to immediately start typing the asset tag after the placeholder is in