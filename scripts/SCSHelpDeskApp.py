...
class HelpdeskApp:
    ...
    def create_widgets(self):
        ...
        self.towns = ["Select Town", "Gallatin", "Hendersonville", "White House", "Portland", "Westmoreland", "Bethpage", "Goodlettsville", "Millersville", "Cottontown"]
        ...
        devices = ["Select Device", "Windows PC", "Windows Laptop", "MacBook", "iPad", "Chromebook", "Apple TV", "Projector", "TV", "Printer", "Yodeck", "Newline Display", "TV Display", "Mitel Phone", "Cameras"]
    ...
    def update_schools(self, selected_town):
        ...
        schools_by_town = {
            "Gallatin": ["Benny Bills Elementary", "Guild Elementary", "Liberty Creek Elementary", "R.T. Fisher Alternative", "Station Camp Elementary", "Union STEM Elementary", "Vena Stewart Elementary", "Liberty Creek Middle", "Shafer Middle", "Rucker-Stewart Middle", "Station Camp Middle", "Gallatin High School", "Liberty Creek High School", "R.T. Fisher Alternative"],
            "Hendersonville": ["Beech Elementary", "George Whitten Elementary", "Gene Brown Elementary", "Indian Lake Elementary", "Jack Anderson Elementary", "Lakeside Park Elementary", "Merrol Hyde Magnet", "Nannie Berry Elementary", "Walton Ferry Elementary", "William Burrus Elementary", "Ellis Middle", "Hawkins Middle", "Knox Doss Middle", "T.W. Hunter Middle", "Hendersonville High School", "Merrol Hyde Magnet"],
